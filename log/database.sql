...
(1, 'Procured Drugs', 'active'),
(2, 'Procured Drugs', 'active'),
(3, 'Procured Drugs', 'active'),
(4, 'Procured Drugs', 'active'),
(5, 'Procured Drugs', 'active'),
(6, 'Procured Drugs', 'active'),
(7, 'Procured Drugs', 'active'),
(8, 'Procured Drugs', 'active'),
(9, 'Procured Drugs', 'active'),
(10, 'Procured Drugs', 'active'),
(11, 'Procured Drugs', 'active'),
(13, 'Procured Drugs', 'active'),
(14, 'Procured Drugs', 'active');
