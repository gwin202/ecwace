	...
	?>
		<div class="col-md-4">
			<div class="panel panel-default">
				...
				<div class="panel-body" align="center">
					<h1><strike>N</strike><?php echo count_total_order_value($connect); ?></h1>
				</div>
			</div>
		</div>
		<div class="col-md-4">
			<div class="panel panel-default">
				...
				<div class="panel-body" align="center">
					<h1><strike>N</strike><?php echo count_total_cash_order_value($connect); ?></h1>
				</div>
			</div>
		</div>
		<div class="col-md-4">
			<div class="panel panel-default">
				...
				<div class="panel-body" align="center">
					<h1><strike>N</strike><?php echo count_total_credit_order_value($connect); ?></h1>
				</div>
			</div>
		</div>
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading"><strong>Total Transfer Order Value</strong></div>
				<div class="panel-body" align="center">
					<h1><strike>N</strike><?php echo count_total_transfer_order_value($connect); ?></h1>
				</div>
			</div>
		</div>
		<hr />
